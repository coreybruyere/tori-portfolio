...
const DEFAULT_IMAGES = [
    ...
    { id: '4', src: full04, thumbnail: thumb04, caption: '[Podcast] - Veg With Victoria Podcast Episode 1', description: <div><audio controls><source src={podcastMp3} type="audio/mpeg"/></audio><div><small>Click the play button to start podcast</small></div></div>},
    { id: '5', src: full05, thumbnail: thumb05, caption: 'Animal Rights Strategic Plan', description: "Animal rights is defining the idea that animals deserve more consideration of what is in their best interests, regardless of whether they are cute or useful to humans, or an endangered species and regardless of whether any human cares about them at all. It stands for recognition that animals are not ours to use for food, clothing, entertainment, or experimentation. It’s our responsibility to respect and protect all animals. We will work with Compassion In World Farming to raise awareness, take action, and keep the momentum going in regards to animal rights. By teaming up with CIWF, our goal is to target governments and organizations that can switch their stance on the welfare and well being of animals and help them make small changes now to help save animals lives today. We want to launch our campaign “Compassion For All, Together We Stand”. This campaign will urge organizations to take a stance on supporting the life of all animals and will bring animal rights awareness to both organizations and lawmakers. With the “Compassion For All, Together We Stand” campaign we will host several open, community-wide conversations via animal rights activist panels in numerous cities and webinars nationwide. These conversations will set the tone in which the campaign would want to stimulate within the community at large. We will promote other campaigns such as “Compassion over Cruelty” and “Kindness over Killing” by using these statements to launch innovative projects and strategic events to abolish the cruel practices of animal abuse worldwide. We will be committed to reducing the suffering of animals as well as bringing animal rights awareness to society, organizations, and government."},
